...
A production-ready RAG system built with LangChain, FAISS, and Streamlit. Upload PDF, DOCX, or TXT documents and get natural language answers with source citations, sharing the Groq LLM backend and the same philosophy of grounded, traceable AI output.
